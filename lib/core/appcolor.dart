...
class Appcolor {
  static const Color kYellewLight = Color(0XFFFFF7EC);
  static const Color kkYellew = Color(0XFFFAF0DA);
  static const Color kYellewDark = Color(0xFFEBBB7F);
  static const Color kRedLight = Color(0xFFFCF0F0F);
